...
main:
  ...
  movl $FLOAT32_BYTE_SIZE * 3, %r8d # 3 floats per vertex
...
.Lshader_creation_failed:
  # The three functions that trigger this error handler all print necessary error information. 
  # Output is not necessary here.
  movq -32(%rbp), %rdi
  call glfwDestroyWindow
  call glfwTerminate
