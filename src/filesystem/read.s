...
.equ MAX_FILE_SIZE, 0x80000000 # limit max file size to 2GB
...
.section .rodata
  ...
  file_size_error_str: .asciz "file size error\n"
  file_too_large_str: .asciz "file too large.\n"
...
fs_read_file:
  ...
  movq $MAX_FILE_SIZE, %rcx
  cmpq %rcx, %rax
  jg .Lfile_too_large # if (x > MAX_FILE_SIZE)
